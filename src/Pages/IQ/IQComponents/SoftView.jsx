...
import IQPanelPage from "../IQPages.jsx/IQPanelPage";
import IQSoftwarePage from "../IQPages.jsx/IQSoftwarePage";

function SoftView({module, match}) {
	...
	return (
		...
		<IQSoftwarePage match={match} sid={module.id}/>
		</Dialog>
		</>
	)
}
