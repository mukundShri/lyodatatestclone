  ...
  <div >
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
      <form action="#" method="POST" onSubmit={updateMobile}>
       ...
       <h6 className='mt-2 ml-3'>Mobile Apk Upload</h6>
           </div> 
          ...
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div>
              ...
              <div class="mt-1">
                <textarea required onChange={(e) => setAbout(e.target.value)} id="about" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="you@apk changes"></textarea>
              </div>
