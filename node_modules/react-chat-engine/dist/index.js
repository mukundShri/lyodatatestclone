...
var ChatList = function ChatList(props) {
  ...
  }, renderChats(chatList), hasMoreChats && chatList.length > 0 && /*#__PURE__*/React__default.createElement(ChatLoader, {
  ...
  }), props.renderNewChatForm ? props.renderNewChatForm(props) : /*#__PURE__*/React__default.createElement("div", {
    style: styles$1.newChatContainer,
    className: "ce-chat-form-container"
  }, /*#__PURE__*/React__default.createElement(NewChatForm, {
...
var ChatSettings = function ChatSettings(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, props.renderChatSettingsTop ? props.renderChatSettingsTop(props, chat) : /*#__PURE__*/React__default.createElement(ChatSettingsTop, _extends({}, props, {
    chat: chat
  })), props.renderPeopleSettings ? props.renderPeopleSettings(props, chat) : /*#__PURE__*/React__default.createElement(PeopleSettings, _extends({}, props, {
    chat: chat
    ...
    chat: chat
  })), props && chat && props.userName === chat.admin.username && /*#__PURE__*/React__default.createElement("div", null, props.renderOptionsSettings ? props.renderOptionsSettings(props, chat) : /*#__PURE__*/React__default.createElement(OptionsSettings, _extends({}, props, {
    chat: chat
  })))));
};
var styles$8 = {
...
var ChatFeed = function ChatFeed(props) {
  ...
  function renderTypers() {
    ...
    return typers.map(function (username, index) {
      return /*#__PURE__*/React__default.createElement(IsTyping, {
        key: "typer_" + index,
        username: username
      });
    });
  ...
  if (conn === undefined) return /*#__PURE__*/React__default.createElement(AuthFail, null);
  if (conn && chats !== null && _$1.isEmpty(chats)) return /*#__PURE__*/React__default.createElement(Welcome, null);
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, connecting && /*#__PURE__*/React__default.createElement(Loading, null), props.renderChatHeader ? props.renderChatHeader(chat) : /*#__PURE__*/React__default.createElement(ChatHeader, null), /*#__PURE__*/React__default.createElement("div", {
  ...
  }), renderMessages(), renderSendingMessages(), renderTypers(), /*#__PURE__*/React__default.createElement("div", {
    style: {
      height: '54px'
    },
